"""
Django settings for pt_site project.
...
SECRET_KEY = '2p)*pn+9%qd9=w1^0mi0(d5$_(@^2igm6-au6pt!nue!ou=h&@'
...
WSGI_APPLICATION = 'pt_site.wsgi.application'
